...
class InterfacesService(object):
    """
    #############################################################
    ...
    **************************************************
    ...
    def InterfaceCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceCreate',
            dcd__service__pb2.InterfaceConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
    ...
    def InterfaceDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceDelete',
            dcd__service__pb2.InterfaceConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def InterfaceLogicalCreate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceLogicalCreate',
            dcd__service__pb2.InterfaceLogicalConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def InterfaceLogicalDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceLogicalDelete',
            dcd__service__pb2.InterfaceLogicalConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def InterfaceFamilyCreate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceFamilyCreate',
            dcd__service__pb2.InterfaceFamilyConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def InterfaceFamilyDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceFamilyDelete',
            dcd__service__pb2.InterfaceFamilyConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def InterfaceAddressCreate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceAddressCreate',
            dcd__service__pb2.InterfaceAddressConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def InterfaceAddressDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceAddressDelete',
            dcd__service__pb2.InterfaceAddressConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def InterfaceRTAddressCreate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceRTAddressCreate',
            dcd__service__pb2.RTConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def InterfaceRTAddressDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.InterfacesService/InterfaceRTAddressDelete',
            dcd__service__pb2.RTConfig.SerializeToString,
            dcd__service__pb2.ConfigResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class AttrQueryService(object):
    ...
    **************************************************
    ...
    @staticmethod
    def InterfacesQueryAttribute(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.AttrQueryService/InterfacesQueryAttribute',
            dcd__service__pb2.AttributeRequestInfo.SerializeToString,
            dcd__service__pb2.AttributeResponseInfo.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class ObjectQueryService(object):
    ...
    **************************************************
    ...
    def isObjectOwner(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.ObjectQueryService/isObjectOwner',
            dcd__service__pb2.ObjectOwnershipQuery.SerializeToString,
            dcd__service__pb2.ObjectOwnershipResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class TimeoutService(object):
    ...
    def setClientTimeout(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.TimeoutService/setClientTimeout',
            dcd__service__pb2.TimeoutInfo.SerializeToString,
            dcd__service__pb2.TimeoutResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class PublicIflService(object):
    ...
    **************************************************
    ...
    def isPublicIfl(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interface.PublicIflService/isPublicIfl',
            dcd__service__pb2.InterfaceLogicalConfig.SerializeToString,
            dcd__service__pb2.PublicIflResp.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
