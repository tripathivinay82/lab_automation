...
class RibStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RouteRemoveMatching = channel.unary_unary(
                '/routing.Rib/RouteRemoveMatching',
                request_serializer=rib__service__pb2.RouteRemoveMatchingRequest.SerializeToString,
                response_deserializer=rib__service__pb2.RouteOperReply.FromString,
                )
...
class RibServicer(object):
    ...
    def RouteRemoveMatching(self, request, context):
        """*
...
def add_RibServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RouteRemoveMatching': grpc.unary_unary_rpc_method_handler(
                    servicer.RouteRemoveMatching,
                    request_deserializer=rib__service__pb2.RouteRemoveMatchingRequest.FromString,
                    response_serializer=rib__service__pb2.RouteOperReply.SerializeToString,
            ),
...
class Rib(object):
    ...
    def RouteAdd(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/routing.Rib/RouteAdd',
            rib__service__pb2.RouteUpdateRequest.SerializeToString,
            rib__service__pb2.RouteOperReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def RouteModify(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/routing.Rib/RouteModify',
            rib__service__pb2.RouteUpdateRequest.SerializeToString,
            rib__service__pb2.RouteOperReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RouteUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/routing.Rib/RouteUpdate',
            rib__service__pb2.RouteUpdateRequest.SerializeToString,
            rib__service__pb2.RouteOperReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RouteRemove(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/routing.Rib/RouteRemove',
            rib__service__pb2.RouteRemoveRequest.SerializeToString,
            rib__service__pb2.RouteOperReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def RouteRemoveMatching(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/routing.Rib/RouteRemoveMatching',
            rib__service__pb2.RouteRemoveMatchingRequest.SerializeToString,
            rib__service__pb2.RouteOperReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def RouteGet(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/routing.Rib/RouteGet',
            rib__service__pb2.RouteGetRequest.SerializeToString,
            rib__service__pb2.RouteGetReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def RouteMonitorRegister(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/routing.Rib/RouteMonitorRegister',
            rib__service__pb2.RouteMonitorRegRequest.SerializeToString,
            rib__service__pb2.RouteMonitorReply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
